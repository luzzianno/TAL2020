...
SEED_CRAWL = 'https://veja.abril.com.br/wp-json/wp/v2/posts?page=1'
...
SEED_SCRAP = 'https://veja.abril.com.br/economia/mesm*o-com-vacina-analistas-esperam-real-fraco-em-relacao-ao-dolar/'


# In[11]:


QUERY_TITLE = "//div[@class='post-header']/h1"
QUERY_CONTENT =  "//section[@class='content']/p"
QUERY_DATE = "//span[@class='author']/span"
